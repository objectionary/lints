...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:eo="https://www.eolang.org" id="empty-object" version="2.0">
  ...
  <xsl:template match="/">
    <defects>
      <xsl:for-each select="/object//o[not(@base) and not(o[not(@base='ξ' and @name='xi🌵')]) and not(eo:atom(.)) and not(eo:has-data(.) and parent::o[@base='Φ.bytes']) and not(parent::o[eo:atom(.)])]">
