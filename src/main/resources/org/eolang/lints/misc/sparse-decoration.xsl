...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:eo="https://www.eolang.org" id="sparse-decoration" version="2.0">
  ...
  <xsl:template match="/">
    <defects>
      <xsl:for-each select="//o[eo:abstract(.) and not(eo:test-name(@name)) and count(o[not(@base='ξ' and @name='xi🌵')])=1 and o[not(@base='ξ' and @name='xi🌵')][1][@name='φ'] and not(eo:has-rho-ref(o[not(@base='ξ' and @name='xi🌵')][1]))]">
